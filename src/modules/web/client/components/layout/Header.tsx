...
export function Header() {
  ...
  return (
    <header className="flex h-14 flex-shrink-0 items-center justify-between gap-3 border-b app-chrome-line bg-card/85 px-3 backdrop-blur supports-[backdrop-filter]:bg-card/75 sm:px-4">
